...
print " "
print "conversion UNIX -> DOS :"

os.system("sed -e 's/$/\r/' suggested_TDACfileTuningInterpolation402.txt > suggested_TDACfileTuningInterpolation402_DOS.txt")
print "done"
